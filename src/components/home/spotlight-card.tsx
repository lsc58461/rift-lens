...
const BASE =
  "group/spot relative overflow-hidden rounded-2xl border border-white/10 bg-card/60 backdrop-blur-md transition-transform duration-300 will-change-transform " +
