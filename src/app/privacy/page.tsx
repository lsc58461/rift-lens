  ...
  return (
    ...
    >
      ...
      <LegalSection title="2. 처리하는 정보와 목적">
        <ul>
          <li>
            <b>이용자가 입력한 소환사명(라이엇 ID)</b> — 전적·실력대 조회를 위해 처리하며, 조회된
          ...
          <li>
            ...
            정보 등 공개 데이터. 실력대 추정과 통계 산출을 위해 보관·가공합니다.
          </li>
          <li>
          ...
          <li>
            <b>디스코드 봇</b> — 알림 채널 설정을 위해 봇이 초대된 서버(길드) ID와 채널 ID만 저장하며,
            디스코드 이용자의 개인정보는 저장하지 않습니다.
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="4. 보관 기간">
        <ul>
          ...
          <li>디스코드 서버·채널 ID: 봇이 해당 서버에서 제거되거나 설정 해제를 요청할 때까지</li>
        </ul>
      </LegalSection>
