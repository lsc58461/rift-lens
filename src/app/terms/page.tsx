  ...
  return (
    ...
    >
      ...
      <LegalSection title="제2조 (서비스의 내용)">
        <ul>
          <li>
            리그 오브 레전드 한국 서버 소환사의 공개 전적 데이터를 바탕으로 한 실력대 추정,
            전적·랭크 추이 조회, 챔피언 통계, 팀·듀오 분석 등 정보 제공
          </li>
      ...
      <LegalSection title="제3조 (정보의 성격과 책임의 한계)">
        <ul>
          <li>
            서비스가 제공하는 &quot;추정 실력대&quot;, &quot;예상 점수&quot;, 챔피언 티어 등은 공개 데이터를
            통계적으로 가공한 <b>참고용 추정치</b>이며, 라이엇 게임즈의 공식 등급이나 매치메이킹
            수치가 아닙니다.
          </li>
          <li>
      ...
      <LegalSection title="제5조 (지식재산권)">
        <ul>
          <li>
            서비스의 구성, 디자인, 소스코드, 추정 알고리즘 및 가공된 통계 자료에 대한 권리는
            운영자에게 있습니다.
          </li>
          <li>
